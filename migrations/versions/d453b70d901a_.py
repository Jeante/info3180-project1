...
Revision ID: d453b70d901a
Revises: 
Create Date: 2020-04-15 20:12:32.887818
...
def upgrade():
    ...
    sa.Column('biography', sa.String(length=190), nullable=True),
    sa.Column('photo', sa.String(length=80), nullable=True),
    sa.Column('datejoined', sa.String(length=255), nullable=True),
